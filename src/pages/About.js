  ...
  return (
    <div  className="about">
      ...
      <div className="aboutBottom">
        ...
        <h2>Only4Cattle.in offers:</h2>
        <ul>
        <li><p>Livestock owners, a platform to showcase their stocks to a plethora of genuinely interested buyers. It optimizes their returns without the hassle of taking livestock to animal fairs, engaging intermittent brokers, doing discounted sales under pressure and curb wait time for sales.</p></li>
        <li><p>Buyers a platform that significantly reduces the time and energy spent on discovery of sellers, livestock verification, price negotiation, and final purchase.</p></li>
        <li><p>Its users an access to vast pool of knowledge, literature and research content on livestock to ensure wellbeing and productivity of livestock.</p></li>
       </ul>
